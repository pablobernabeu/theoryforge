...
| Rigor checklist | `tf_check(theory)` → report list | `theory.check()` → `dict` |
...
- Maturity: <maturity>
- Derivation chain verified: <yes|no>   (yes iff rigor item derivation_chain status == "pass")
...
- Theory ID: <id>
- Maturity: <maturity>
- Aggregate rigor score: <fmt(aggregate_score)>/100
- Gate: <gate>
