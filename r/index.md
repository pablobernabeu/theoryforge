...
same name. Behaviour is pinned by the shared specification
...
for a fuller walk-through of building, checking and diagramming a
theory.
...
The package reference index gives the complete, grouped function list.
