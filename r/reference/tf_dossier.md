...
appended preregistration document. Deterministic and byte-identical to
the Python `theory.dossier()`. See API_SPEC.md section 19.
...
#> 3. tf_add_proposition: p1
#> 4. tf_add_prediction: h1
#> 
#> ## Preregistration
#> 
