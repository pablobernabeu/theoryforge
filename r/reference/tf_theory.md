...
Mirrors the Python `theoryforge.new_theory`. Seeds
`schema_version = "1.0"` and a first provenance entry
`{step:"1", action:"tf_theory", detail:<id>}`. See API_SPEC.md section
8.
