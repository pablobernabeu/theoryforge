...
downloaded to follow the documentation. The Python twin reaches the same
files through example_names() and example_path().
...
Byte-identical diagram intermediate representations, and native
rendering.
...
The conditional independencies a causal theory commits to,
