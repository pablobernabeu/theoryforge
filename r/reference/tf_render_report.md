...
`render = TRUE`, invokes `quarto render` (environment-dependent, not
parity-tested). Mirrors the Python `theory.render_report()`. See
API_SPEC.md section 22.
...
#> [1] "/tmp/RtmpzUHebu/file18d64a66b9cc.qmd"
```
