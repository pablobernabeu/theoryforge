...
and is excluded from parity and CI. Mirrors the Python
`theory.osf_push()`. See API_SPEC.md section 24.
...
- base_url:
  ...
  OSF storage base URL; override to target a non-default host. Mirrors
  the Python `base_url` argument.
