...
length, or the pair is refused. Returns a data frame sorted by
descending cosine then `(a, b)`, flagging pairs at or above `threshold`
for review. This assistive screen complements the deterministic lexical
