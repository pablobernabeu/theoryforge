...
- Test severity averages the declared `severity` field of each prediction (warning with a score of 0 when no prediction declares one), and passes at 0.5 or above. It is distinct from the computed severity of the `tf_severity()` rubric, which offers a principled way of choosing the declared values.
