...
#'
#' PARITY-EXEMPT: results depend on a user-supplied embedding function whose
#' outputs are not deterministic across model versions or SDKs. This is the
#' assistive counterpart to the deterministic lexical screen in
#' \code{tf_redundancy_check}; it is excluded from the parity contract and CI.
