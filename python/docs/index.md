...
of [the R package](https://pablobernabeu.github.io/theoryforge/r/) of the same name, and the
two return identical results (see the [API reference](api.md) for the shared specification
